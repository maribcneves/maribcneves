...
Estudante de **Banco de Dados com ênfase em Ciência de Dados e IA** na CESAR School (Recife), em transição de carreira depois de quase 7 anos no marketing digital. Sou formada em Publicidade pela UFPE, com especialização em marketing orientado a dados pela ESPM.

Na Moura Dubeux, maior incorporadora do Nordeste, liderei o canal digital responsável por **20% das vendas da empresa**. Foi lá que descobri que o que mais me move é usar dados para orientar decisões: relatórios de performance, CRM, tratamento de bases com mais de 170 mil leads e a implantação de 3 soluções com IA generativa.
